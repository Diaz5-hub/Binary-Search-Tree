...
private:
	...
	//					void process(Node* )
	void inorder(Node* node, std::function<void(Node*)> proc);
	void preorder(Node* node, std::function<void(Node*)> proc);
	void postorder(Node* node, std::function<void(Node*)> proc);
...
#endif//BINARYSEARCHTREE_H_X_XMMXX